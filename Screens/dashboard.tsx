...
const Dashboard = () => {
  ...
  const handleCardPress = (item: any) => {
    if (!item.photo || item.photo === "https://i.sstatic.net/l60Hf.png") {
  ...
  const renderCard = ({ item }: { item: any }) => {
    const hasInitialForm =
      item.isInitialConcentFilled === true ||
      item.initialConcentStatus === "Filled";
              ...
              return (
                <View
                  ...
                  style={{
                    ...
                    marginHorizontal: 2,
                    borderRadius: 10,
                    backgroundColor: filled ? "#0077A8" : "#E0E0E0",
                  }}
                />
              );
            })}
